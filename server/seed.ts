...
export async function seedDatabase() {
  try {
    ...
    const coursesData = [
      ...
      {
        title: "Basics of Neuroscience and Psychology",
        description: "Explore the brain-behavior connection and cognitive science",
      ...
      {
        title: "Emotional Intelligence and Soft Skills",
        description: "Develop EQ and interpersonal communication abilities",
      ...
      },
      {
        ...
        description: "Practice meditation and focus techniques for mental clarity",
        instructor: "Marcus Singh",
        category: "mind-thinking" as const,
        rating: "4.6",
        reviewCount: 367,
        duration: 100,
      ...
      },
      {
        ...
        description: "Learn to make better decisions by understanding mental shortcuts",
      ...
      {
        title: "Financial Literacy and Investments",
        description: "Master personal finance, budgeting, and investment strategies",
      ...
      {
        title: "Crypto",
        description: "Understanding cryptocurrency, blockchain, and digital assets",
      ...
      },
      {
        ...
        description: "Building and scaling successful business ventures",
      ...
      {
        title: "Economics",
        description: "Fundamentals of macro and microeconomics",
      ...
      // Career Skills
      {
        title: "Teaching and Mentoring Skills",
        description: "Effective techniques for education and professional development",
      ...
      },
      {
        ...
        description: "Master the art of persuasive communication and presentation",
      ...
      },
      {
        ...
        description: "Complete guide to online marketing strategies and tools",
      ...
      },
      {
        ...
        description: "Analyze data and create compelling visual stories",
      ...
      },
      {
        ...
        description: "Optimize your efficiency and achieve more in less time",
      ...
      {
        title: "Global Challenges and Sustainable Development",
        description: "Understanding climate change, sustainability, and global solutions",
      ...
      },
      {
        ...
        description: "Navigate ethical challenges in the digital age",
        instructor: "Dr. Sophie Turner",
        category: "future-thinking" as const,
        rating: "4.6",
        reviewCount: 189,
        duration: 100,
      ...
      // Health and Body
      {
        title: "Nutrition: Basics and Habits",
        description: "Build healthy eating habits and understand nutritional science",
        instructor: "Dr. Nina Rodriguez",
      ...
      {
        title: "Functional Training and Discipline",
        description: "Develop strength, mobility, and athletic performance",
      ...
      {
        title: "Biohacking and Recovery",
        description: "Optimize your biology for peak performance and recovery",
        instructor: "Dr. Ben Taylor",
        category: "health-body" as const,
        rating: "4.7",
        reviewCount: 267,
        duration: 105,
      ...
      {
        title: "Sleep, Regimen and Energy",
        description: "Master sleep science and energy management techniques",
